...
- [x] `R_IA64_NONE` (0)
- [x] `R_IA64_IMM14` (0x21), `R_IA64_IMM22` (0x22), `R_IA64_IMM64` (0x23)
- [x] `R_IA64_DIR32MSB` (0x24), `R_IA64_DIR32LSB` (0x25), `R_IA64_DIR64MSB` (0x26), `R_IA64_DIR64LSB` (0x27)
- [x] `R_IA64_GPREL22` (0x2A), `R_IA64_GPREL64I` (0x2B), `R_IA64_GPREL32MSB` (0x2C), `R_IA64_GPREL32LSB` (0x2D), `R_IA64_GPREL64MSB` (0x2E), `R_IA64_GPREL64LSB` (0x2F)
- [x] `R_IA64_LTOFF22` (0x32), `R_IA64_LTOFF64I` (0x33)
- [x] `R_IA64_PLTOFF22` (0x3A), `R_IA64_PLTOFF64I` (0x3B), `R_IA64_PLTOFF64MSB` (0x3E), `R_IA64_PLTOFF64LSB` (0x3F)
- [x] `R_IA64_FPTR64I` (0x43), `R_IA64_FPTR32MSB` (0x44), `R_IA64_FPTR32LSB` (0x45), `R_IA64_FPTR64MSB` (0x46), `R_IA64_FPTR64LSB` (0x47)
- [x] `R_IA64_PCREL21B` (0x49), `R_IA64_PCREL21M` (0x4A), `R_IA64_PCREL21F` (0x4B), `R_IA64_PCREL32MSB` (0x4C), `R_IA64_PCREL32LSB` (0x4D), `R_IA64_PCREL64MSB` (0x4E), `R_IA64_PCREL64LSB` (0x4F)
- [x] `R_IA64_LTOFF_FPTR22` (0x52), `R_IA64_LTOFF_FPTR64I` (0x53), `R_IA64_LTOFF_FPTR32MSB` (0x54), `R_IA64_LTOFF_FPTR32LSB` (0x55), `R_IA64_LTOFF_FPTR64MSB` (0x56), `R_IA64_LTOFF_FPTR64LSB` (0x57)
- [x] `R_IA64_SEGREL32MSB` (0x5C), `R_IA64_SEGREL32LSB` (0x5D), `R_IA64_SEGREL64MSB` (0x5E), `R_IA64_SEGREL64LSB` (0x5F)
- [x] `R_IA64_SECREL32MSB` (0x64), `R_IA64_SECREL32LSB` (0x65), `R_IA64_SECREL64MSB` (0x66), `R_IA64_SECREL64LSB` (0x67)
- [x] `R_IA64_REL32MSB` (0x6C), `R_IA64_REL32LSB` (0x6D), `R_IA64_REL64MSB` (0x6E), `R_IA64_REL64LSB` (0x6F)
- [x] Dynamic: `R_IA64_IPLTMSB` (0x80), `R_IA64_IPLTLSB` (0x81), `R_IA64_COPY` (0x84), `R_IA64_SUB` (0x85)

...
- [ ] **Memory Management:** (REQ: REQ-01-0001)
    ...
    - [ ] **Memory Management (BSD/Mach Design):** (REQ: REQ-01-0065)
        ...
        - [ ] **VM Subsystem (Machine Independent):** (REQ: REQ-01-0425)
            ...
            - [x] **VM Map Entries (`vm_map_entry`):** (REQ: REQ-01-0433)
                ...
                - [x] `inheritance`: share, copy, none (for fork behavior). (REQ: REQ-01-0437)
                - [x] `wired_count`: prevent pageout for this region. (REQ: REQ-01-0438)
                - [x] `vm_map_insert(map, object, offset, start, end, prot)`. (REQ: REQ-01-0439)
                - [x] `vm_map_remove(map, start, end)`: remove entries in range. (REQ: REQ-01-0440)
            ...
            - [x] **VM Objects (`vm_object`):** (REQ: REQ-01-0445)
                ...
                - [x] `vm_object_reference(obj)` / `vm_object_deallocate(obj)`. (REQ: REQ-01-0452)
                - [x] `vm_object_page_lookup(obj, pindex)`: find resident page. (REQ: REQ-01-0453)
                - [x] `vm_object_page_insert(obj, page, pindex)`. (REQ: REQ-01-0454)
                - [x] `vm_object_shadow(obj, offset, size)`: create shadow for COW. (REQ: REQ-01-0455)
                - [x] `vm_object_collapse(obj)`: collapse shadow chain when possible. (REQ: REQ-01-0456)
            - [x] **Fault Handler (`vm_fault`):** (REQ: REQ-01-0457)
                - [x] High-level page fault resolution. (REQ: REQ-01-0458)
                - [x] `vm_fault(map, va, fault_type)`: main entry point. (REQ: REQ-01-0459)
                - [x] Look up `vm_map_entry` for faulting VA. (REQ: REQ-01-0460)
                - [x] Check protection against fault type. (REQ: REQ-01-0461)
                - [x] Walk shadow object chain to find page or pager. (REQ: REQ-01-0462)
                - [x] If page found in object: map it via `pmap_enter`. (REQ: REQ-01-0457)
                - [x] If page not found: call pager to fetch from backing store. (REQ: REQ-01-0457)
                - [x] **Zero-fill on demand:** anonymous pages filled with zeros on first access. (REQ: REQ-01-0465)
                - [x] **Prefaulting:** heuristic to load surrounding pages during I/O. (REQ: REQ-01-0466, REQ-01-0501)
            - [x] **Copy-on-Write (COW):** (REQ: REQ-01-0467)
                - [x] `vm_fault` logic for write to read-only shared page. (REQ: REQ-01-0468)
                - [x] Create shadow object on fork. (REQ: REQ-01-0469)
                - [x] Mark parent entries as copy-on-write. (REQ: REQ-01-0470)
            ...
            - [x] **Advanced Features:** (REQ: REQ-01-0489, REQ-01-0671)
                - [x] **File-backed mmap (`MAP_FILE`):** (REQ: REQ-01-0490)
            ...
            - [x] **Testing:** (REQ: REQ-01-0051, REQ-01-0142, REQ-01-0315, REQ-01-0411, REQ-01-0503, REQ-01-0553, REQ-01-0618, REQ-01-0648, REQ-01-0683, REQ-01-0716, REQ-01-0841, REQ-01-0962)
                ...
                - [x] Integration: mmap anonymous memory, write, fork, verify COW isolation. (REQ: REQ-01-0510)
                - [x] Integration: mmap file, read, modify, msync, verify on-disk. (REQ: REQ-01-0511)
            - [x] **Documentation:** (REQ: REQ-01-0062, REQ-01-0150, REQ-01-0329, REQ-01-0421, REQ-01-0512, REQ-01-0562, REQ-01-0654, REQ-01-0853, REQ-01-0972)
                - [x] Internal doc: VM hierarchy (map → entry → object → page). (REQ: REQ-01-0513)
                - [x] Internal doc: COW shadow chain and collapse algorithm. (REQ: REQ-01-0514)
                - [x] Internal doc: pager interface contract. (REQ: REQ-01-0515)
    ...
    - [x] **User Memory Syscalls:** (REQ: REQ-01-0565)
        - [x] `sys_mmap(addr, len, prot, flags, fd, offset)`: map memory. (REQ: REQ-01-0566)
            ...
            - [x] `MAP_SHARED`: file-backed write-through mapping. (REQ: REQ-01-0569)
            - [x] `MAP_FIXED`: map at exact address (unmap existing). (REQ: REQ-01-0570)
            - [x] Alignment to page boundary. (REQ: REQ-01-0571)
        - [x] `sys_munmap(addr, len)`: unmap region. (REQ: REQ-01-0572)
        - [x] `sys_mprotect(addr, len, prot)`: change protection. (REQ: REQ-01-0573)
        - [x] `sys_brk(addr)` / `sys_sbrk(incr)`: adjust data segment. (REQ: REQ-01-0574)
        - [x] `sys_msync(addr, len, flags)`: sync dirty pages to backing store. (REQ: REQ-01-0575)

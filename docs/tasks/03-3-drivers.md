...
- [ ] **Storage Subsystem (Unified SCSI Stack):** (REQ: REQ-03-0001)
    ...
    - [ ] **Core Architecture (CAM/Mid-layer):** (REQ: REQ-03-0002)
        ...
        - [ ] **Data Structures (`scsi.h`):** (REQ: REQ-03-0003)
            ...
            - [ ] `scsi_sense_fixed`: SPC-3 fixed-format sense data. (REQ: REQ-03-0036)
        ...
        - [ ] **Initialization (`scsi_init`):** (REQ: REQ-03-0047)
            - [ ] Initialize device registry (pre-allocate pool of `scsi_device_t`, fixed-size static pool). (REQ: REQ-03-0048)
            - [ ] Initialize request pool (pre-allocate `scsi_request_t`, fixed-size static pool). (REQ: REQ-03-0049)

...
- [x] **RNG Subsystem (`/dev/random`, `/dev/urandom`):** <!-- random.c, random_internal.h, sys/random.h --> (REQ: REQ-03-0892)
    - [x] **Core Infrastructure:** (REQ: REQ-03-0727, REQ-03-0893)
        - [x] **Data Structures:** (REQ: REQ-03-0894)
            - [x] Define `struct entropy_pool` (input pool, output pool, counters). <!-- random_internal.h --> (REQ: REQ-03-0895)

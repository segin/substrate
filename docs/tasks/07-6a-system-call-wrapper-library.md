...
### 6a. System Call Wrapper Library (`lib/sys`)
- [x] **Foundation:** (REQ: REQ-07-0001)
    - [x] Create `lib/sys/` directory structure. (REQ: REQ-07-0002)
    - [x] Implement `syscall.S`: Raw i386 `int $0x80` entry (6 args via ebx-ebp). (REQ: REQ-07-0003)
    - [x] Create `include/sys/syscall.h`: `SYS_*` constants and `syscall()` prototype. (REQ: REQ-07-0004)
    - [x] Add to `lib/Makefile` SUBDIRS. (REQ: REQ-07-0005)
- [x] **VM Information Syscalls:** (REQ: REQ-07-0006)
    - [x] `sysinfo()` wrapper (`SYS_sysinfo`): Total/free RAM, uptime, load averages. (REQ: REQ-07-0007)
        - [x] Kernel: Implement `sys_sysinfo()` returning `struct sysinfo`. (REQ: REQ-07-0008)
        - [x] `lib/sys/sysinfo.c`: Wrapper function. (REQ: REQ-07-0009)
        - [x] Man page: `sysinfo(2)`. (REQ: REQ-07-0010)
    - [x] `getpagesize()` wrapper: Return `PAGE_SIZE` (4096 on i386). (REQ: REQ-07-0011)
        - [x] `lib/sys/getpagesize.c`: Wrapper function. (REQ: REQ-07-0012)
        - [x] Man page: `getpagesize(2)`. (REQ: REQ-07-0013)
    - [x] `mlock()`/`munlock()` wrappers: Lock/unlock pages in RAM. (REQ: REQ-07-0014)
        - [x] `lib/sys/mlock.c`: Wrapper functions. (REQ: REQ-07-0015)
        - [x] Man pages: `mlock(2)`, `munlock(2)`. (REQ: REQ-07-0016)
- [x] **Process Information Syscalls:** (REQ: REQ-07-0017)
    - [x] `getpid()`/`getppid()` wrappers. (REQ: REQ-07-0018)
        - [x] `lib/sys/getpid.c`: Wrapper functions. (REQ: REQ-07-0019)
        - [x] Man pages: `getpid(2)`, `getppid(2)`. (REQ: REQ-07-0020)
    - [x] `getuid()`/`getgid()`/`geteuid()`/`getegid()` wrappers. (REQ: REQ-07-0021)
        - [x] `lib/sys/getuid.c`: Wrapper functions. (REQ: REQ-07-0022)
        - [x] Man pages: `getuid(2)`, `getgid(2)`, `geteuid(2)`, `getegid(2)`. (REQ: REQ-07-0023)
    - [x] `getpgid()`/`setpgid()`/`getpgrp()` wrappers. (REQ: REQ-07-0024)
        - [x] `lib/sys/pgrp.c`: Wrapper functions. (REQ: REQ-07-0025, REQ-07-0028)
        - [x] Man pages: `getpgid(2)`, `setpgid(2)`, `getpgrp(2)`. (REQ: REQ-07-0026)
    - [x] `getsid()`/`setsid()` wrappers. (REQ: REQ-07-0027)
        - [x] `lib/sys/pgrp.c`: Wrapper functions. (REQ: REQ-07-0025, REQ-07-0028)
        - [x] Man pages: `getsid(2)`, `setsid(2)`. (REQ: REQ-07-0029)
    - [x] `getrusage()` wrapper: Resource usage (user/sys time, memory). (REQ: REQ-07-0030)
        - [x] Kernel: Hooked up `sys_getrusage()`. (REQ: REQ-07-0031)
        - [x] `lib/sys/getrusage.c`: Wrapper function. (REQ: REQ-07-0032)
        - [x] Man page: `getrusage(2)`. (REQ: REQ-07-0033)
    - [x] `times()` wrapper: Process times (user, sys, children). (REQ: REQ-07-0034)
        - [x] Kernel: Hooked up `sys_times()`. (REQ: REQ-07-0035)
        - [x] `lib/sys/times.c`: Wrapper function. (REQ: REQ-07-0036)
        - [x] Man page: `times(2)`. (REQ: REQ-07-0037)
- [x] **Special-Purpose Syscalls:** (REQ: REQ-07-0038)
    - [x] `vm86()` wrapper (SYS_vm86): Enter VM86 mode. (REQ: REQ-07-0039)
        - [x] `lib/sys/vm86.c`: Typed wrapper. (REQ: REQ-07-0040)
        - [x] Man page: `vm86(2)`. (REQ: REQ-07-0041)
    - [x] `ptrace()` wrapper: Process tracing. (REQ: REQ-07-0042)
        - [x] `lib/sys/ptrace.c`: Wrapper function. (REQ: REQ-07-0043)
        - [x] Man page: `ptrace(2)`. (REQ: REQ-07-0044)
    - [x] `reboot()` wrapper: System reboot/power off. (REQ: REQ-07-0045)
        - [x] `lib/sys/reboot.c`: Wrapper function. (REQ: REQ-07-0046)
        - [x] Man page: `reboot(2)`. (REQ: REQ-07-0047)
- [x] **Sysctl Interface:** (REQ: REQ-07-0048)
    - [x] `sysctl()` wrapper: Kernel tunable access. (REQ: REQ-07-0049)
        - [x] Kernel: Hooked up `sys_sysctl()` MIB tree. (REQ: REQ-07-0050)
        - [x] `lib/sys/sysctl.c`: Wrapper function. (REQ: REQ-07-0051)
...
- [x] **Wrapper Number Hygiene:** (REQ: REQ-07-0054)
    ...
    - [x] Enforce that every `SYS_*` used in `lib/sys` is defined in `sys/arch/i386/syscall.h`. (REQ: REQ-07-0048)
- [x] **Coverage Completion:** (REQ: REQ-07-0055)
...
- [x] **Stub Burn-Down:** (REQ: REQ-07-0055)

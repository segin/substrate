...
- the active VGA text VT keeps scrolling strictly in software within the tty-visible rows; the reserved status row is never part of a hardware scroll region.

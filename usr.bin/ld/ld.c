...
static int ensure_dynamic_import_sections_x64(elfobj_t *out, const dyn_import_vec_t *imports) {
    size_t i;
    size_t plt_count = 0;
    size_t got_count = 0;
    elf_section_t *sec;
    ...
    if (got_count != 0) {
        ...
        if (elf_section_set_align(sec, 8) != ELF_OK || set_section_zero_data(sec, 24 * got_count) != 0) {
            return -1;
        }
    }
    return 0;

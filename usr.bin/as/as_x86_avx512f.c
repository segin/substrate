...
int as_x86_encode_avx512f(const as_x86_avx512f_insn_t *insn, uint8_t *out, size_t out_cap,
    ...
    static const avx512f_desc_t descs[] = {
        ...
        {"vcvtpd2dq", AVX512F_FORM_RR, 0xe6, AS_EVEX_MAP_0F, AS_EVEX_PP_F2, 1, 2, 0, 0, 0, 0},
        {"vcvtpd2udq", AVX512F_FORM_RR, 0x79, AS_EVEX_MAP_0F, AS_EVEX_PP_NONE, 1, 2, 0, 0, 0, 0},
        ...
        {"vpmovdb", AVX512F_FORM_REV_RR, 0x31, AS_EVEX_MAP_0F38, AS_EVEX_PP_F3, 0, 2, 0, 0, 0, 0},
        {"vpmovdw", AVX512F_FORM_REV_RR, 0x33, AS_EVEX_MAP_0F38, AS_EVEX_PP_F3, 0, 2, 0, 0, 0, 0},
        {"vpmovqb", AVX512F_FORM_REV_RR, 0x32, AS_EVEX_MAP_0F38, AS_EVEX_PP_F3, 0, 2, 0, 0, 0, 0},
        {"vpmovqd", AVX512F_FORM_REV_RR, 0x35, AS_EVEX_MAP_0F38, AS_EVEX_PP_F3, 0, 2, 0, 0, 0, 0},
        {"vpmovqw", AVX512F_FORM_REV_RR, 0x34, AS_EVEX_MAP_0F38, AS_EVEX_PP_F3, 0, 2, 0, 0, 0, 0},
        ...
        {"vgatherdps", AVX512F_FORM_GATHER, 0x92, AS_EVEX_MAP_0F38, AS_EVEX_PP_66, 0, 2, 0, 1, 0, 1},
        {"vgatherdpd", AVX512F_FORM_GATHER, 0x92, AS_EVEX_MAP_0F38, AS_EVEX_PP_66, 1, 2, 0, 1, 0, 1},
        {"vgatherqps", AVX512F_FORM_GATHER, 0x93, AS_EVEX_MAP_0F38, AS_EVEX_PP_66, 0, 2, 0, 1, 0, 1},
        {"vgatherqpd", AVX512F_FORM_GATHER, 0x93, AS_EVEX_MAP_0F38, AS_EVEX_PP_66, 1, 2, 0, 1, 0, 1},
        {"vpgatherdd", AVX512F_FORM_GATHER, 0x90, AS_EVEX_MAP_0F38, AS_EVEX_PP_66, 0, 2, 0, 1, 0, 1},
        {"vpgatherdq", AVX512F_FORM_GATHER, 0x90, AS_EVEX_MAP_0F38, AS_EVEX_PP_66, 1, 2, 0, 1, 0, 1},
        {"vpgatherqd", AVX512F_FORM_GATHER, 0x91, AS_EVEX_MAP_0F38, AS_EVEX_PP_66, 0, 2, 0, 1, 0, 1},
        {"vpgatherqq", AVX512F_FORM_GATHER, 0x91, AS_EVEX_MAP_0F38, AS_EVEX_PP_66, 1, 2, 0, 1, 0, 1},
        {"vscatterdps", AVX512F_FORM_SCATTER, 0xa2, AS_EVEX_MAP_0F38, AS_EVEX_PP_66, 0, 2, 0, 0, 1, 1},
        {"vscatterdpd", AVX512F_FORM_SCATTER, 0xa2, AS_EVEX_MAP_0F38, AS_EVEX_PP_66, 1, 2, 0, 0, 1, 1},
        {"vscatterqps", AVX512F_FORM_SCATTER, 0xa3, AS_EVEX_MAP_0F38, AS_EVEX_PP_66, 0, 2, 0, 0, 1, 1},
        {"vscatterqpd", AVX512F_FORM_SCATTER, 0xa3, AS_EVEX_MAP_0F38, AS_EVEX_PP_66, 1, 2, 0, 0, 1, 1},
        {"vpscatterdd", AVX512F_FORM_SCATTER, 0xa0, AS_EVEX_MAP_0F38, AS_EVEX_PP_66, 0, 2, 0, 0, 1, 1},
        {"vpscatterdq", AVX512F_FORM_SCATTER, 0xa0, AS_EVEX_MAP_0F38, AS_EVEX_PP_66, 1, 2, 0, 0, 1, 1},
        {"vpscatterqd", AVX512F_FORM_SCATTER, 0xa1, AS_EVEX_MAP_0F38, AS_EVEX_PP_66, 0, 2, 0, 0, 1, 1},
        {"vpscatterqq", AVX512F_FORM_SCATTER, 0xa1, AS_EVEX_MAP_0F38, AS_EVEX_PP_66, 1, 2, 0, 0, 1, 1},
    };
    size_t i;

...
int as_x86_encode_avx512dq(const as_x86_avx512dq_insn_t *insn, uint8_t *out, size_t out_cap,
    ...
    static const dq_desc_t descs[] = {
        ...
        {"vpmuldq", DQ_FORM_RRR, 0x28, AS_EVEX_MAP_0F38, AS_EVEX_PP_66, 1, -1, 0, 0, 0},
        ...
        {"vpsrlq", DQ_FORM_RRR, 0xd3, AS_EVEX_MAP_0F, AS_EVEX_PP_66, 1, -1, 0, 0, 0},
        {"vpaddq", DQ_FORM_RRR, 0xd4, AS_EVEX_MAP_0F, AS_EVEX_PP_66, 1, -1, 0, 0, 0},
        ...
        {"vpsllq", DQ_FORM_RRR, 0xf3, AS_EVEX_MAP_0F, AS_EVEX_PP_66, 1, -1, 0, 0, 0},
        {"vpmuludq", DQ_FORM_RRR, 0xf4, AS_EVEX_MAP_0F, AS_EVEX_PP_66, 1, -1, 0, 0, 0},
        {"vpsubq", DQ_FORM_RRR, 0xfb, AS_EVEX_MAP_0F, AS_EVEX_PP_66, 1, -1, 0, 0, 0},

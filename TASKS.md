...
- [ ] **Memory Management:**
    - [ ] **Physical Memory Manager (PMM Refactor):**
        ...
        - [ ] **Core Allocator Rewrite:**
            ...
            - [ ] **Algorithms:**
                - [ ] **Single Page:** O(1) Free List allocation (replace bitmap scan).
...
- [ ] **FAT16/32:**
    ...
    - [ ] **Unix Compatibility Layer (UMSDOS-style):**
        - [ ] **Metadata Storage:** Use hidden `--LINUX-.---` file for inodes/permissions.
        - [ ] **Semantics:** Support hard links, symlinks, and owners/groups on FAT.
        - [ ] **Sync Tool:** Utility to synchronize DOS changes with metadata.
- [ ] **Pseudo-FS:**
    - [ ] **DevFS (`/dev`):**

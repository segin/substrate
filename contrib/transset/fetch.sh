#!/bin/sh
#
# contrib/transset/fetch.sh — fetch the transset tarball, verify, extract,
# apply the substrate patch series (if any).

set -eu

VERSION="1.0.4"
TARBALL="transset-${VERSION}.tar.gz"
...
TREE_DIR="${BUILD_DIR}/transset-${VERSION}"
...
echo "==> transset ${VERSION} ready at ${TREE_DIR}"

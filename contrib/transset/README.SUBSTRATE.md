# transset on Substrate

transset 1.0.4, cross-built for `i386-unknown-substrate`.

Upstream tarball: `https://www.x.org/archive/individual/app/transset-1.0.4.tar.gz`
...
./build.sh      # cross-configure, make, stage into dist-overlay/dist-transset
```

`build.sh` stages into `${SUBSTRATE_TOP}/dist-overlay/dist-transset/usr`, which

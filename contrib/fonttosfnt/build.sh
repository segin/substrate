#!/bin/sh
#
# contrib/fonttosfnt/build.sh — cross-build fonttosfnt for substrate.
#
# Wrap a bitmap font in an sfnt (TrueType) container.
#
# Env:
#   STAGE1_PREFIX   substrate toolchain prefix (default /opt/substrate)
#   DESTDIR         staging dir (default ${SUBSTRATE_TOP}/dist-overlay/dist-fonttosfnt)
...
LIB="fonttosfnt"
VERSION="1.2.5"
TREE_DIR="${HERE}/build/fonttosfnt-${VERSION}"
...
: "${DESTDIR:=${SUBSTRATE_TOP}/dist-overlay/dist-fonttosfnt}"

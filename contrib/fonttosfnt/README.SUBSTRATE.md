# fonttosfnt on Substrate

fonttosfnt 1.2.5, cross-built for `i386-unknown-substrate`.

Upstream tarball: `https://www.x.org/archive/individual/app/fonttosfnt-1.2.5.tar.gz`
...
./build.sh      # cross-configure, make, stage into dist-overlay/dist-fonttosfnt
```

`build.sh` stages into `${SUBSTRATE_TOP}/dist-overlay/dist-fonttosfnt/usr`, which

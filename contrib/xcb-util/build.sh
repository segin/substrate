#!/bin/sh
#
# contrib/xcb-util/build.sh — cross-build xcb-util for substrate.
#
# Client-side utility functions for XCB: xcb-atom, xcb-aux and xcb-event.
#
# Env:
#   STAGE1_PREFIX   substrate toolchain prefix (default /opt/substrate)
#   DESTDIR         staging dir (default ${SUBSTRATE_TOP}/dist-overlay/dist-xcb-util)
...
LIB="xcb-util"
VERSION="0.4.1"
TREE_DIR="${HERE}/build/xcb-util-${VERSION}"
...
: "${DESTDIR:=${SUBSTRATE_TOP}/dist-overlay/dist-xcb-util}"

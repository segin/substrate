#!/bin/sh
#
# contrib/xcmsdb/build.sh — cross-build xcmsdb for substrate.
#
# Load, query and remove Device Colour Characterization data.
#
# Env:
#   STAGE1_PREFIX   substrate toolchain prefix (default /opt/substrate)
#   DESTDIR         staging dir (default ${SUBSTRATE_TOP}/dist-overlay/dist-xcmsdb)
...
LIB="xcmsdb"
VERSION="1.0.7"
TREE_DIR="${HERE}/build/xcmsdb-${VERSION}"
...
: "${DESTDIR:=${SUBSTRATE_TOP}/dist-overlay/dist-xcmsdb}"

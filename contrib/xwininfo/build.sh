#!/bin/sh
#
# contrib/xwininfo/build.sh — cross-build xwininfo for substrate.
#
# Print information about a window.
#
# Env:
#   STAGE1_PREFIX   substrate toolchain prefix (default /opt/substrate)
#   DESTDIR         staging dir (default ${SUBSTRATE_TOP}/dist-overlay/dist-xwininfo)
...
LIB="xwininfo"
VERSION="1.1.7"
TREE_DIR="${HERE}/build/xwininfo-${VERSION}"
...
: "${DESTDIR:=${SUBSTRATE_TOP}/dist-overlay/dist-xwininfo}"

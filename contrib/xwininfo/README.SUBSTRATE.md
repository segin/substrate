# xwininfo on Substrate

xwininfo 1.1.7, cross-built for `i386-unknown-substrate`.

Upstream tarball: `https://www.x.org/archive/individual/app/xwininfo-1.1.7.tar.gz`
...
./build.sh      # cross-configure, make, stage into dist-overlay/dist-xwininfo
```

`build.sh` stages into `${SUBSTRATE_TOP}/dist-overlay/dist-xwininfo/usr`, which

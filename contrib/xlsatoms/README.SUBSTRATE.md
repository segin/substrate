# xlsatoms on Substrate

xlsatoms 1.1.5, cross-built for `i386-unknown-substrate`.

Upstream tarball: `https://www.x.org/archive/individual/app/xlsatoms-1.1.5.tar.gz`
...
./build.sh      # cross-configure, make, stage into dist-overlay/dist-xlsatoms
```

`build.sh` stages into `${SUBSTRATE_TOP}/dist-overlay/dist-xlsatoms/usr`, which

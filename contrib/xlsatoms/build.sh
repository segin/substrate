#!/bin/sh
#
# contrib/xlsatoms/build.sh — cross-build xlsatoms for substrate.
#
# List the atoms interned on a display.
#
# Env:
#   STAGE1_PREFIX   substrate toolchain prefix (default /opt/substrate)
#   DESTDIR         staging dir (default ${SUBSTRATE_TOP}/dist-overlay/dist-xlsatoms)
...
LIB="xlsatoms"
VERSION="1.1.5"
TREE_DIR="${HERE}/build/xlsatoms-${VERSION}"
...
: "${DESTDIR:=${SUBSTRATE_TOP}/dist-overlay/dist-xlsatoms}"

#!/bin/sh
#
# contrib/listres/build.sh — cross-build listres for substrate.
#
# List the resources of Xt widget classes.
#
# Env:
#   STAGE1_PREFIX   substrate toolchain prefix (default /opt/substrate)
#   DESTDIR         staging dir (default ${SUBSTRATE_TOP}/dist-overlay/dist-listres)
...
LIB="listres"
VERSION="1.0.7"
TREE_DIR="${HERE}/build/listres-${VERSION}"
...
: "${DESTDIR:=${SUBSTRATE_TOP}/dist-overlay/dist-listres}"

#!/bin/sh
#
# contrib/xset/fetch.sh — fetch the xset tarball, verify, extract,
# apply the substrate patch series.

set -eu

VERSION="1.2.5"
TARBALL="xset-${VERSION}.tar.xz"
...
TREE_DIR="${BUILD_DIR}/xset-${VERSION}"
...
echo "==> xset ${VERSION} ready at ${TREE_DIR}"

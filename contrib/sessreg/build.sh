#!/bin/sh
#
# contrib/sessreg/build.sh — cross-build sessreg for substrate.
#
# Add and remove utmp/wtmp entries for X sessions.
#
# Env:
#   STAGE1_PREFIX   substrate toolchain prefix (default /opt/substrate)
#   DESTDIR         staging dir (default ${SUBSTRATE_TOP}/dist-overlay/dist-sessreg)
...
LIB="sessreg"
VERSION="1.1.4"
TREE_DIR="${HERE}/build/sessreg-${VERSION}"
...
: "${DESTDIR:=${SUBSTRATE_TOP}/dist-overlay/dist-sessreg}"

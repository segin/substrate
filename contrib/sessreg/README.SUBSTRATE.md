# sessreg on Substrate

sessreg 1.1.4, cross-built for `i386-unknown-substrate`.

Upstream tarball: `https://www.x.org/archive/individual/app/sessreg-1.1.4.tar.gz`
...
./build.sh      # cross-configure, make, stage into dist-overlay/dist-sessreg
```

`build.sh` stages into `${SUBSTRATE_TOP}/dist-overlay/dist-sessreg/usr`, which

#!/bin/sh
#
# contrib/sessreg/fetch.sh — fetch the sessreg tarball, verify, extract,
# apply the substrate patch series (if any).

set -eu

VERSION="1.1.4"
TARBALL="sessreg-${VERSION}.tar.gz"
...
TREE_DIR="${BUILD_DIR}/sessreg-${VERSION}"
...
echo "==> sessreg ${VERSION} ready at ${TREE_DIR}"

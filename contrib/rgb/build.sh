#!/bin/sh
#
# contrib/rgb/build.sh — cross-build rgb for substrate.
#
# The X colour-name database, plus showrgb.
#
# Env:
#   STAGE1_PREFIX   substrate toolchain prefix (default /opt/substrate)
#   DESTDIR         staging dir (default ${SUBSTRATE_TOP}/dist-overlay/dist-rgb)
...
LIB="rgb"
VERSION="1.1.1"
TREE_DIR="${HERE}/build/rgb-${VERSION}"
...
: "${DESTDIR:=${SUBSTRATE_TOP}/dist-overlay/dist-rgb}"

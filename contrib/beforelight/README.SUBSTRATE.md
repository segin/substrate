# beforelight on Substrate

beforelight 1.0.6, cross-built for `i386-unknown-substrate`.

Upstream tarball: `https://www.x.org/archive/individual/app/beforelight-1.0.6.tar.gz`
...
./build.sh      # cross-configure, make, stage into dist-overlay/dist-beforelight
```

`build.sh` stages into `${SUBSTRATE_TOP}/dist-overlay/dist-beforelight/usr`, which

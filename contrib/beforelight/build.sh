#!/bin/sh
#
# contrib/beforelight/build.sh — cross-build beforelight for substrate.
#
# Sample screen saver client driven by the MIT-SCREEN-SAVER extension.
#
# Env:
#   STAGE1_PREFIX   substrate toolchain prefix (default /opt/substrate)
#   DESTDIR         staging dir (default ${SUBSTRATE_TOP}/dist-overlay/dist-beforelight)
...
LIB="beforelight"
VERSION="1.0.6"
TREE_DIR="${HERE}/build/beforelight-${VERSION}"
...
: "${DESTDIR:=${SUBSTRATE_TOP}/dist-overlay/dist-beforelight}"

#!/bin/sh
#
# contrib/xmore/build.sh — cross-build xmore for substrate.
#
# Plain-text pager in a window.
#
# Env:
#   STAGE1_PREFIX   substrate toolchain prefix (default /opt/substrate)
#   DESTDIR         staging dir (default ${SUBSTRATE_TOP}/dist-overlay/dist-xmore)
...
LIB="xmore"
VERSION="1.0.4"
TREE_DIR="${HERE}/build/xmore-${VERSION}"
...
: "${DESTDIR:=${SUBSTRATE_TOP}/dist-overlay/dist-xmore}"

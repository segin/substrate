#!/bin/sh
#
# contrib/xmore/fetch.sh — fetch the xmore tarball, verify, extract,
# apply the substrate patch series (if any).

set -eu

VERSION="1.0.4"
TARBALL="xmore-${VERSION}.tar.gz"
...
TREE_DIR="${BUILD_DIR}/xmore-${VERSION}"
...
echo "==> xmore ${VERSION} ready at ${TREE_DIR}"

...
xmore 1.0.4, cross-built for `i386-unknown-substrate`.

Upstream tarball: `https://www.x.org/archive/individual/app/xmore-1.0.4.tar.gz`
...
./build.sh      # cross-configure, make, stage into dist-overlay/dist-xmore
```

`build.sh` stages into `${SUBSTRATE_TOP}/dist-overlay/dist-xmore/usr`, which

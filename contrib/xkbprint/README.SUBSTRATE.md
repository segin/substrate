# xkbprint on Substrate

xkbprint 1.0.8, cross-built for `i386-unknown-substrate`.

Upstream tarball: `https://www.x.org/archive/individual/app/xkbprint-1.0.8.tar.gz`
...
./build.sh      # cross-configure, make, stage into dist-overlay/dist-xkbprint
```

`build.sh` stages into `${SUBSTRATE_TOP}/dist-overlay/dist-xkbprint/usr`, which

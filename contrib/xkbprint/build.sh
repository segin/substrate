#!/bin/sh
#
# contrib/xkbprint/build.sh — cross-build xkbprint for substrate.
#
# Print an XKB keyboard description.
#
# Env:
#   STAGE1_PREFIX   substrate toolchain prefix (default /opt/substrate)
#   DESTDIR         staging dir (default ${SUBSTRATE_TOP}/dist-overlay/dist-xkbprint)
...
LIB="xkbprint"
VERSION="1.0.8"
TREE_DIR="${HERE}/build/xkbprint-${VERSION}"
...
: "${DESTDIR:=${SUBSTRATE_TOP}/dist-overlay/dist-xkbprint}"

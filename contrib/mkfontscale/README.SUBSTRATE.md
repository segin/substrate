# mkfontscale on Substrate

mkfontscale 1.2.4, cross-built for `i386-unknown-substrate`.

Upstream tarball: `https://www.x.org/archive/individual/app/mkfontscale-1.2.4.tar.gz`
...
./build.sh      # cross-configure, make, stage into dist-overlay/dist-mkfontscale
```

`build.sh` stages into `${SUBSTRATE_TOP}/dist-overlay/dist-mkfontscale/usr`, which

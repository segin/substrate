#!/bin/sh
#
# contrib/mkfontscale/fetch.sh — fetch the mkfontscale tarball, verify, extract,
# apply the substrate patch series (if any).

set -eu

VERSION="1.2.4"
TARBALL="mkfontscale-${VERSION}.tar.gz"
...
TREE_DIR="${BUILD_DIR}/mkfontscale-${VERSION}"
...
echo "==> mkfontscale ${VERSION} ready at ${TREE_DIR}"

#!/bin/sh
#
# contrib/mkfontscale/build.sh — cross-build mkfontscale for substrate.
#
# Build the fonts.scale / fonts.dir index of a font directory.
#
# Env:
#   STAGE1_PREFIX   substrate toolchain prefix (default /opt/substrate)
#   DESTDIR         staging dir (default ${SUBSTRATE_TOP}/dist-overlay/dist-mkfontscale)
...
LIB="mkfontscale"
VERSION="1.2.4"
TREE_DIR="${HERE}/build/mkfontscale-${VERSION}"
...
: "${DESTDIR:=${SUBSTRATE_TOP}/dist-overlay/dist-mkfontscale}"

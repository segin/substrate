# viewres on Substrate

viewres 1.0.8, cross-built for `i386-unknown-substrate`.

Upstream tarball: `https://www.x.org/archive/individual/app/viewres-1.0.8.tar.gz`
...
./build.sh      # cross-configure, make, stage into dist-overlay/dist-viewres
```

`build.sh` stages into `${SUBSTRATE_TOP}/dist-overlay/dist-viewres/usr`, which

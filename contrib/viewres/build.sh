#!/bin/sh
#
# contrib/viewres/build.sh — cross-build viewres for substrate.
#
# Browse the Xt widget class tree.
#
# Env:
#   STAGE1_PREFIX   substrate toolchain prefix (default /opt/substrate)
#   DESTDIR         staging dir (default ${SUBSTRATE_TOP}/dist-overlay/dist-viewres)
...
LIB="viewres"
VERSION="1.0.8"
TREE_DIR="${HERE}/build/viewres-${VERSION}"
...
: "${DESTDIR:=${SUBSTRATE_TOP}/dist-overlay/dist-viewres}"

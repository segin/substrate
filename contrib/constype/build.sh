#!/bin/sh
#
# contrib/constype/build.sh — cross-build constype for substrate.
#
# Print the Sun console type.  SunOS-specific; kept for completeness.
#
# Env:
#   STAGE1_PREFIX   substrate toolchain prefix (default /opt/substrate)
#   DESTDIR         staging dir (default ${SUBSTRATE_TOP}/dist-overlay/dist-constype)
...
LIB="constype"
VERSION="1.0.6"
TREE_DIR="${HERE}/build/constype-${VERSION}"
...
: "${DESTDIR:=${SUBSTRATE_TOP}/dist-overlay/dist-constype}"

#!/bin/sh
#
# contrib/xbiff/build.sh — cross-build xbiff for substrate.
#
# Mailbox flag that raises when new mail arrives.
#
# Env:
#   STAGE1_PREFIX   substrate toolchain prefix (default /opt/substrate)
#   DESTDIR         staging dir (default ${SUBSTRATE_TOP}/dist-overlay/dist-xbiff)
...
LIB="xbiff"
VERSION="1.0.6"
TREE_DIR="${HERE}/build/xbiff-${VERSION}"
...
: "${DESTDIR:=${SUBSTRATE_TOP}/dist-overlay/dist-xbiff}"

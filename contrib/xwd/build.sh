#!/bin/sh
#
# contrib/xwd/build.sh — cross-build xwd for substrate.
#
# Dump an X window to a file.
#
# Env:
#   STAGE1_PREFIX   substrate toolchain prefix (default /opt/substrate)
#   DESTDIR         staging dir (default ${SUBSTRATE_TOP}/dist-overlay/dist-xwd)
...
LIB="xwd"
VERSION="1.0.10"
TREE_DIR="${HERE}/build/xwd-${VERSION}"
...
: "${DESTDIR:=${SUBSTRATE_TOP}/dist-overlay/dist-xwd}"

#!/bin/sh
#
# contrib/xrandr/build.sh — cross-build xrandr for substrate.
#
# Query and change screen size, orientation and outputs.  Needs libXrandr.
#
# Env:
#   STAGE1_PREFIX   substrate toolchain prefix (default /opt/substrate)
#   DESTDIR         staging dir (default ${SUBSTRATE_TOP}/dist-overlay/dist-xrandr)
...
LIB="xrandr"
VERSION="1.5.4"
TREE_DIR="${HERE}/build/xrandr-${VERSION}"
...
: "${DESTDIR:=${SUBSTRATE_TOP}/dist-overlay/dist-xrandr}"

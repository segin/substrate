#!/bin/sh
#
# contrib/fslsfonts/fetch.sh — fetch the fslsfonts tarball, verify, extract,
# apply the substrate patch series (if any).

set -eu

VERSION="1.0.7"
TARBALL="fslsfonts-${VERSION}.tar.gz"
...
TREE_DIR="${BUILD_DIR}/fslsfonts-${VERSION}"
...
echo "==> fslsfonts ${VERSION} ready at ${TREE_DIR}"

#!/bin/sh
#
# contrib/fslsfonts/build.sh — cross-build fslsfonts for substrate.
#
# List the fonts served by an X font server.  Needs libFS.
#
# Env:
#   STAGE1_PREFIX   substrate toolchain prefix (default /opt/substrate)
#   DESTDIR         staging dir (default ${SUBSTRATE_TOP}/dist-overlay/dist-fslsfonts)
...
LIB="fslsfonts"
VERSION="1.0.7"
TREE_DIR="${HERE}/build/fslsfonts-${VERSION}"
...
: "${DESTDIR:=${SUBSTRATE_TOP}/dist-overlay/dist-fslsfonts}"

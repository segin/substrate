#!/bin/sh
#
# contrib/xdpyinfo/build.sh — cross-build xdpyinfo for substrate.
#
# Print display, screen and extension information.
#
# Env:
#   STAGE1_PREFIX   substrate toolchain prefix (default /opt/substrate)
#   DESTDIR         staging dir (default ${SUBSTRATE_TOP}/dist-overlay/dist-xdpyinfo)
...
LIB="xdpyinfo"
VERSION="1.4.0"
TREE_DIR="${HERE}/build/xdpyinfo-${VERSION}"
...
: "${DESTDIR:=${SUBSTRATE_TOP}/dist-overlay/dist-xdpyinfo}"

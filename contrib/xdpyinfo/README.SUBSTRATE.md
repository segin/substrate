# xdpyinfo on Substrate

xdpyinfo 1.4.0, cross-built for `i386-unknown-substrate`.

Upstream tarball: `https://www.x.org/archive/individual/app/xdpyinfo-1.4.0.tar.gz`
...
./build.sh      # cross-configure, make, stage into dist-overlay/dist-xdpyinfo
```

`build.sh` stages into `${SUBSTRATE_TOP}/dist-overlay/dist-xdpyinfo/usr`, which

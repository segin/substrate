#!/bin/sh
#
# contrib/libXv/fetch.sh — fetch the libXv tarball, verify, extract,
# apply the substrate patch series (if any).

set -eu

VERSION="1.0.13"
TARBALL="libXv-${VERSION}.tar.gz"
...
TREE_DIR="${BUILD_DIR}/libXv-${VERSION}"
...
echo "==> libXv ${VERSION} ready at ${TREE_DIR}"

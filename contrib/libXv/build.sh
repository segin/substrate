#!/bin/sh
#
# contrib/libXv/build.sh — cross-build libXv for substrate.
#
# Client library for the Xv video extension.
#
# Env:
#   STAGE1_PREFIX   substrate toolchain prefix (default /opt/substrate)
#   DESTDIR         staging dir (default ${SUBSTRATE_TOP}/dist-overlay/dist-libXv)
...
LIB="libXv"
VERSION="1.0.13"
TREE_DIR="${HERE}/build/libXv-${VERSION}"
...
: "${DESTDIR:=${SUBSTRATE_TOP}/dist-overlay/dist-libXv}"

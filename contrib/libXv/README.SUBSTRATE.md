...
libXv 1.0.13, cross-built for `i386-unknown-substrate`.

Upstream tarball: `https://www.x.org/archive/individual/lib/libXv-1.0.13.tar.gz`
...
./build.sh      # cross-configure, make, stage into dist-overlay/dist-libXv
```

`build.sh` stages into `${SUBSTRATE_TOP}/dist-overlay/dist-libXv/usr`, which

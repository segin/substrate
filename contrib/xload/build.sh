#!/bin/sh
#
# contrib/xload/build.sh — cross-build xload for substrate.
#
# System load average graph.
#
# Env:
#   STAGE1_PREFIX   substrate toolchain prefix (default /opt/substrate)
#   DESTDIR         staging dir (default ${SUBSTRATE_TOP}/dist-overlay/dist-xload)
...
LIB="xload"
VERSION="1.2.2"
TREE_DIR="${HERE}/build/xload-${VERSION}"
...
: "${DESTDIR:=${SUBSTRATE_TOP}/dist-overlay/dist-xload}"

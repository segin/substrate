#!/bin/sh
#
# contrib/xditview/build.sh — cross-build xditview for substrate.
#
# View ditroff output.
#
# Env:
#   STAGE1_PREFIX   substrate toolchain prefix (default /opt/substrate)
#   DESTDIR         staging dir (default ${SUBSTRATE_TOP}/dist-overlay/dist-xditview)
...
LIB="xditview"
VERSION="1.0.7"
TREE_DIR="${HERE}/build/xditview-${VERSION}"
...
: "${DESTDIR:=${SUBSTRATE_TOP}/dist-overlay/dist-xditview}"

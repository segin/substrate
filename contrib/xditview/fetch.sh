#!/bin/sh
#
# contrib/xditview/fetch.sh — fetch the xditview tarball, verify, extract,
# apply the substrate patch series (if any).

set -eu

VERSION="1.0.7"
TARBALL="xditview-${VERSION}.tar.gz"
...
TREE_DIR="${BUILD_DIR}/xditview-${VERSION}"
...
echo "==> xditview ${VERSION} ready at ${TREE_DIR}"

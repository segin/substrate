#!/bin/sh
#
# contrib/libXxf86vm/fetch.sh — fetch the libXxf86vm tarball, verify, extract,
# apply the substrate patch series (if any).

set -eu

VERSION="1.1.7"
TARBALL="libXxf86vm-${VERSION}.tar.gz"
...
TREE_DIR="${BUILD_DIR}/libXxf86vm-${VERSION}"
...
echo "==> libXxf86vm ${VERSION} ready at ${TREE_DIR}"

#!/bin/sh
#
# contrib/libXxf86vm/build.sh — cross-build libXxf86vm for substrate.
#
# Client library for the XFree86-VidModeExtension.
#
# Env:
#   STAGE1_PREFIX   substrate toolchain prefix (default /opt/substrate)
#   DESTDIR         staging dir (default ${SUBSTRATE_TOP}/dist-overlay/dist-libXxf86vm)
...
LIB="libXxf86vm"
VERSION="1.1.7"
TREE_DIR="${HERE}/build/libXxf86vm-${VERSION}"
...
: "${DESTDIR:=${SUBSTRATE_TOP}/dist-overlay/dist-libXxf86vm}"

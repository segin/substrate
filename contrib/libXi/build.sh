#!/bin/sh
#
# contrib/libXi/build.sh — cross-build libXi for substrate.
# The X Input Extension client library (XInput / XInput2).  Produces
# shared + static libraries, headers and the xi.pc pkg-config file.
# Needed by TDE's kcontrol.  Depends on xorgproto, libX11, libXext.

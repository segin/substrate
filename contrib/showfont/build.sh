#!/bin/sh
#
# contrib/showfont/build.sh — cross-build showfont for substrate.
#
# Dump a font from an X font server.  Needs libFS.
#
# Env:
#   STAGE1_PREFIX   substrate toolchain prefix (default /opt/substrate)
#   DESTDIR         staging dir (default ${SUBSTRATE_TOP}/dist-overlay/dist-showfont)
...
LIB="showfont"
VERSION="1.0.7"
TREE_DIR="${HERE}/build/showfont-${VERSION}"
...
: "${DESTDIR:=${SUBSTRATE_TOP}/dist-overlay/dist-showfont}"

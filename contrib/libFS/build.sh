#!/bin/sh
#
# contrib/libFS/build.sh — cross-build libFS for substrate.
#
# Client library for the X Font Server protocol.
#
# Env:
#   STAGE1_PREFIX   substrate toolchain prefix (default /opt/substrate)
#   DESTDIR         staging dir (default ${SUBSTRATE_TOP}/dist-overlay/dist-libFS)
...
LIB="libFS"
VERSION="1.0.10"
TREE_DIR="${HERE}/build/libFS-${VERSION}"
...
: "${DESTDIR:=${SUBSTRATE_TOP}/dist-overlay/dist-libFS}"

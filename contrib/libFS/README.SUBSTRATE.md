...
libFS 1.0.10, cross-built for `i386-unknown-substrate`.

Upstream tarball: `https://www.x.org/archive/individual/lib/libFS-1.0.10.tar.gz`
...
./build.sh      # cross-configure, make, stage into dist-overlay/dist-libFS
```

`build.sh` stages into `${SUBSTRATE_TOP}/dist-overlay/dist-libFS/usr`, which

#!/bin/sh
#
# contrib/xauth/fetch.sh — fetch the xauth tarball, verify, extract,
# apply the substrate patch series.

set -eu

VERSION="1.1.5"
TARBALL="xauth-${VERSION}.tar.xz"
...
TREE_DIR="${BUILD_DIR}/xauth-${VERSION}"
...
echo "==> xauth ${VERSION} ready at ${TREE_DIR}"

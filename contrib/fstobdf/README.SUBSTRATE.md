# fstobdf on Substrate

fstobdf 1.0.8, cross-built for `i386-unknown-substrate`.

Upstream tarball: `https://www.x.org/archive/individual/app/fstobdf-1.0.8.tar.gz`
...
./build.sh      # cross-configure, make, stage into dist-overlay/dist-fstobdf
```

`build.sh` stages into `${SUBSTRATE_TOP}/dist-overlay/dist-fstobdf/usr`, which

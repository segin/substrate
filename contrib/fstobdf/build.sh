#!/bin/sh
#
# contrib/fstobdf/build.sh — cross-build fstobdf for substrate.
#
# Read a font from an X font server and dump it as BDF.  Needs libFS.
#
# Env:
#   STAGE1_PREFIX   substrate toolchain prefix (default /opt/substrate)
#   DESTDIR         staging dir (default ${SUBSTRATE_TOP}/dist-overlay/dist-fstobdf)
...
LIB="fstobdf"
VERSION="1.0.8"
TREE_DIR="${HERE}/build/fstobdf-${VERSION}"
...
: "${DESTDIR:=${SUBSTRATE_TOP}/dist-overlay/dist-fstobdf}"

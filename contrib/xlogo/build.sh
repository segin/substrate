#!/bin/sh
#
# contrib/xlogo/build.sh — cross-build xlogo for substrate.
#
# The X logo.
#
# Env:
#   STAGE1_PREFIX   substrate toolchain prefix (default /opt/substrate)
#   DESTDIR         staging dir (default ${SUBSTRATE_TOP}/dist-overlay/dist-xlogo)
...
LIB="xlogo"
VERSION="1.0.7"
TREE_DIR="${HERE}/build/xlogo-${VERSION}"
...
: "${DESTDIR:=${SUBSTRATE_TOP}/dist-overlay/dist-xlogo}"

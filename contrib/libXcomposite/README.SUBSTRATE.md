# libXcomposite on Substrate

libXcomposite 0.4.7, cross-built for `i386-unknown-substrate`.

Upstream tarball: `https://www.x.org/archive/individual/lib/libXcomposite-0.4.7.tar.gz`
...
./build.sh      # cross-configure, make, stage into dist-overlay/dist-libXcomposite
```

`build.sh` stages into `${SUBSTRATE_TOP}/dist-overlay/dist-libXcomposite/usr`, which

#!/bin/sh
#
# contrib/libXcomposite/fetch.sh — fetch the libXcomposite tarball, verify, extract,
# apply the substrate patch series (if any).

set -eu

VERSION="0.4.7"
TARBALL="libXcomposite-${VERSION}.tar.gz"
...
TREE_DIR="${BUILD_DIR}/libXcomposite-${VERSION}"
...
echo "==> libXcomposite ${VERSION} ready at ${TREE_DIR}"

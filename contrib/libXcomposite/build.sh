#!/bin/sh
#
# contrib/libXcomposite/build.sh — cross-build libXcomposite for substrate.
#
# Client library for the Composite extension.
#
# Env:
#   STAGE1_PREFIX   substrate toolchain prefix (default /opt/substrate)
#   DESTDIR         staging dir (default ${SUBSTRATE_TOP}/dist-overlay/dist-libXcomposite)
...
LIB="libXcomposite"
VERSION="0.4.7"
TREE_DIR="${HERE}/build/libXcomposite-${VERSION}"
...
: "${DESTDIR:=${SUBSTRATE_TOP}/dist-overlay/dist-libXcomposite}"
...
PKGP=""; CPP=""; LDF=""
for d in xorgproto xcb-proto libXau xtrans libxcb libX11 libXext libXfixes; do
...
# Libtool archives point at the build host's /usr/lib and break a later
# cross link if they reach the sysroot.

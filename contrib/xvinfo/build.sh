#!/bin/sh
#
# contrib/xvinfo/build.sh — cross-build xvinfo for substrate.
#
# Print Xv adaptor information.  Needs libXv.
#
# Env:
#   STAGE1_PREFIX   substrate toolchain prefix (default /opt/substrate)
#   DESTDIR         staging dir (default ${SUBSTRATE_TOP}/dist-overlay/dist-xvinfo)
...
LIB="xvinfo"
VERSION="1.1.6"
TREE_DIR="${HERE}/build/xvinfo-${VERSION}"
...
: "${DESTDIR:=${SUBSTRATE_TOP}/dist-overlay/dist-xvinfo}"

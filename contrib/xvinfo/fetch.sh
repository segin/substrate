#!/bin/sh
#
# contrib/xvinfo/fetch.sh — fetch the xvinfo tarball, verify, extract,
# apply the substrate patch series (if any).

set -eu

VERSION="1.1.6"
TARBALL="xvinfo-${VERSION}.tar.gz"
...
TREE_DIR="${BUILD_DIR}/xvinfo-${VERSION}"
...
echo "==> xvinfo ${VERSION} ready at ${TREE_DIR}"

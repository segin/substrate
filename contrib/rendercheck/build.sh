#!/bin/sh
#
# contrib/rendercheck/build.sh — cross-build rendercheck for substrate.
#
# Test suite for the RENDER extension.
#
# Env:
#   STAGE1_PREFIX   substrate toolchain prefix (default /opt/substrate)
#   DESTDIR         staging dir (default ${SUBSTRATE_TOP}/dist-overlay/dist-rendercheck)
...
LIB="rendercheck"
VERSION="1.5"
TREE_DIR="${HERE}/build/rendercheck-${VERSION}"
...
: "${DESTDIR:=${SUBSTRATE_TOP}/dist-overlay/dist-rendercheck}"

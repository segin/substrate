# rendercheck on Substrate

rendercheck 1.5, cross-built for `i386-unknown-substrate`.

Upstream tarball: `https://www.x.org/archive/individual/app/rendercheck-1.5.tar.gz`
...
./build.sh      # cross-configure, make, stage into dist-overlay/dist-rendercheck
```

`build.sh` stages into `${SUBSTRATE_TOP}/dist-overlay/dist-rendercheck/usr`, which

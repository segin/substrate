#!/bin/sh
#
# contrib/setxkbmap/build.sh — cross-build setxkbmap for substrate.
#
# Set the keyboard map through the XKB extension.
#
# Env:
#   STAGE1_PREFIX   substrate toolchain prefix (default /opt/substrate)
#   DESTDIR         staging dir (default ${SUBSTRATE_TOP}/dist-overlay/dist-setxkbmap)
...
LIB="setxkbmap"
VERSION="1.3.5"
TREE_DIR="${HERE}/build/setxkbmap-${VERSION}"
...
: "${DESTDIR:=${SUBSTRATE_TOP}/dist-overlay/dist-setxkbmap}"

# setxkbmap on Substrate

setxkbmap 1.3.5, cross-built for `i386-unknown-substrate`.

Upstream tarball: `https://www.x.org/archive/individual/app/setxkbmap-1.3.5.tar.gz`
...
./build.sh      # cross-configure, make, stage into dist-overlay/dist-setxkbmap
```

`build.sh` stages into `${SUBSTRATE_TOP}/dist-overlay/dist-setxkbmap/usr`, which

#!/bin/sh
#
# contrib/setxkbmap/fetch.sh — fetch the setxkbmap tarball, verify, extract,
# apply the substrate patch series (if any).

set -eu

VERSION="1.3.5"
TARBALL="setxkbmap-${VERSION}.tar.gz"
...
TREE_DIR="${BUILD_DIR}/setxkbmap-${VERSION}"
...
echo "==> setxkbmap ${VERSION} ready at ${TREE_DIR}"

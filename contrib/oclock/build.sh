#!/bin/sh
#
# contrib/oclock/build.sh — cross-build oclock for substrate.
#
# Round analogue clock; uses the SHAPE extension for its outline.
#
# Env:
#   STAGE1_PREFIX   substrate toolchain prefix (default /opt/substrate)
#   DESTDIR         staging dir (default ${SUBSTRATE_TOP}/dist-overlay/dist-oclock)
...
LIB="oclock"
VERSION="1.0.6"
TREE_DIR="${HERE}/build/oclock-${VERSION}"
...
: "${DESTDIR:=${SUBSTRATE_TOP}/dist-overlay/dist-oclock}"

#!/bin/sh
#
# contrib/oclock/fetch.sh — fetch the oclock tarball, verify, extract,
# apply the substrate patch series (if any).

set -eu

VERSION="1.0.6"
TARBALL="oclock-${VERSION}.tar.gz"
...
TREE_DIR="${BUILD_DIR}/oclock-${VERSION}"
...
echo "==> oclock ${VERSION} ready at ${TREE_DIR}"

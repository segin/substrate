#!/bin/sh
#
# contrib/xsm/build.sh — cross-build xsm for substrate.
#
# X session manager.
#
# Env:
#   STAGE1_PREFIX   substrate toolchain prefix (default /opt/substrate)
#   DESTDIR         staging dir (default ${SUBSTRATE_TOP}/dist-overlay/dist-xsm)
...
LIB="xsm"
VERSION="1.0.6"
TREE_DIR="${HERE}/build/xsm-${VERSION}"
...
: "${DESTDIR:=${SUBSTRATE_TOP}/dist-overlay/dist-xsm}"

#!/bin/sh
#
# contrib/xsetpointer/build.sh — cross-build xsetpointer for substrate.
#
# Choose which XInput device drives the core pointer.
#
# Env:
#   STAGE1_PREFIX   substrate toolchain prefix (default /opt/substrate)
#   DESTDIR         staging dir (default ${SUBSTRATE_TOP}/dist-overlay/dist-xsetpointer)
...
LIB="xsetpointer"
VERSION="1.0.1"
TREE_DIR="${HERE}/build/xsetpointer-${VERSION}"
...
: "${DESTDIR:=${SUBSTRATE_TOP}/dist-overlay/dist-xsetpointer}"

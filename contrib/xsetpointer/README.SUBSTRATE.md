# xsetpointer on Substrate

xsetpointer 1.0.1, cross-built for `i386-unknown-substrate`.

Upstream tarball: `https://www.x.org/archive/individual/app/xsetpointer-1.0.1.tar.gz`
...
./build.sh      # cross-configure, make, stage into dist-overlay/dist-xsetpointer
```

`build.sh` stages into `${SUBSTRATE_TOP}/dist-overlay/dist-xsetpointer/usr`, which

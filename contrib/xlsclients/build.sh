#!/bin/sh
#
# contrib/xlsclients/build.sh — cross-build xlsclients for substrate.
#
# List the clients connected to a display.
#
# Env:
#   STAGE1_PREFIX   substrate toolchain prefix (default /opt/substrate)
#   DESTDIR         staging dir (default ${SUBSTRATE_TOP}/dist-overlay/dist-xlsclients)
...
LIB="xlsclients"
VERSION="1.1.6"
TREE_DIR="${HERE}/build/xlsclients-${VERSION}"
...
: "${DESTDIR:=${SUBSTRATE_TOP}/dist-overlay/dist-xlsclients}"

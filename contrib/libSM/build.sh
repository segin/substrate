#!/bin/sh
#
# contrib/libSM/build.sh — cross-build libSM for substrate.
# the X Session Management client library.
...
#   DESTDIR         staging dir (default ${SUBSTRATE_TOP}/dist-overlay/dist-libSM)

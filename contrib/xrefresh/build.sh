#!/bin/sh
#
# contrib/xrefresh/build.sh — cross-build xrefresh for substrate.
#
# Repaint all or part of the screen.
#
# Env:
#   STAGE1_PREFIX   substrate toolchain prefix (default /opt/substrate)
#   DESTDIR         staging dir (default ${SUBSTRATE_TOP}/dist-overlay/dist-xrefresh)
...
LIB="xrefresh"
VERSION="1.1.1"
TREE_DIR="${HERE}/build/xrefresh-${VERSION}"
...
: "${DESTDIR:=${SUBSTRATE_TOP}/dist-overlay/dist-xrefresh}"

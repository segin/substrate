#!/bin/sh
#
# contrib/xfd/build.sh — cross-build xfd for substrate.
#
# Display every glyph in a font.
#
# Env:
#   STAGE1_PREFIX   substrate toolchain prefix (default /opt/substrate)
#   DESTDIR         staging dir (default ${SUBSTRATE_TOP}/dist-overlay/dist-xfd)
...
LIB="xfd"
VERSION="1.1.6"
TREE_DIR="${HERE}/build/xfd-${VERSION}"
...
: "${DESTDIR:=${SUBSTRATE_TOP}/dist-overlay/dist-xfd}"

#!/bin/sh
#
# contrib/libXtst/build.sh — cross-build libXtst for substrate.
# The X Test extension client library (XTEST + record).  Produces
# shared + static libraries, headers and the xi.pc pkg-config file.
# Needed by TDE tdm_greet/screensaver.  Depends on xorgproto, libX11, libXext, libXi.
...
PKGP=""; CPP=""; LDF=""
for d in xorgproto xcb-proto libXau xtrans libxcb libX11 libXext libXfixes libXi; do

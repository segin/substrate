#!/bin/sh
#
# contrib/xgc/build.sh — cross-build xgc for substrate.
#
# Demo / test for the core drawing requests.
#
# Env:
#   STAGE1_PREFIX   substrate toolchain prefix (default /opt/substrate)
#   DESTDIR         staging dir (default ${SUBSTRATE_TOP}/dist-overlay/dist-xgc)
...
LIB="xgc"
VERSION="1.0.7"
TREE_DIR="${HERE}/build/xgc-${VERSION}"
...
: "${DESTDIR:=${SUBSTRATE_TOP}/dist-overlay/dist-xgc}"

# xmodmap on Substrate

xmodmap 1.0.12, cross-built for `i386-unknown-substrate`.

Upstream tarball: `https://www.x.org/archive/individual/app/xmodmap-1.0.12.tar.gz`
...
./build.sh      # cross-configure, make, stage into dist-overlay/dist-xmodmap
```

`build.sh` stages into `${SUBSTRATE_TOP}/dist-overlay/dist-xmodmap/usr`, which

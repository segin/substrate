#!/bin/sh
#
# contrib/xmodmap/build.sh — cross-build xmodmap for substrate.
#
# Edit the keyboard and pointer modifier maps.
#
# Env:
#   STAGE1_PREFIX   substrate toolchain prefix (default /opt/substrate)
#   DESTDIR         staging dir (default ${SUBSTRATE_TOP}/dist-overlay/dist-xmodmap)
...
LIB="xmodmap"
VERSION="1.0.12"
TREE_DIR="${HERE}/build/xmodmap-${VERSION}"
...
: "${DESTDIR:=${SUBSTRATE_TOP}/dist-overlay/dist-xmodmap}"

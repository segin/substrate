# xsetmode on Substrate

xsetmode 1.0.0, cross-built for `i386-unknown-substrate`.

Upstream tarball: `https://www.x.org/archive/individual/app/xsetmode-1.0.0.tar.gz`
...
./build.sh      # cross-configure, make, stage into dist-overlay/dist-xsetmode
```

`build.sh` stages into `${SUBSTRATE_TOP}/dist-overlay/dist-xsetmode/usr`, which

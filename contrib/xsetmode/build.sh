#!/bin/sh
#
# contrib/xsetmode/build.sh — cross-build xsetmode for substrate.
#
# Set the mode of an XInput device.
#
# Env:
#   STAGE1_PREFIX   substrate toolchain prefix (default /opt/substrate)
#   DESTDIR         staging dir (default ${SUBSTRATE_TOP}/dist-overlay/dist-xsetmode)
...
LIB="xsetmode"
VERSION="1.0.0"
TREE_DIR="${HERE}/build/xsetmode-${VERSION}"
...
: "${DESTDIR:=${SUBSTRATE_TOP}/dist-overlay/dist-xsetmode}"

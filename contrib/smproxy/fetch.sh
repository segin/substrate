#!/bin/sh
#
# contrib/smproxy/fetch.sh — fetch the smproxy tarball, verify, extract,
# apply the substrate patch series (if any).

set -eu

VERSION="1.0.8"
TARBALL="smproxy-${VERSION}.tar.gz"
...
TREE_DIR="${BUILD_DIR}/smproxy-${VERSION}"
...
echo "==> smproxy ${VERSION} ready at ${TREE_DIR}"

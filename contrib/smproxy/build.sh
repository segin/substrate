#!/bin/sh
#
# contrib/smproxy/build.sh — cross-build smproxy for substrate.
#
# Session-management proxy for clients that do not speak XSMP themselves.
#
# Env:
#   STAGE1_PREFIX   substrate toolchain prefix (default /opt/substrate)
#   DESTDIR         staging dir (default ${SUBSTRATE_TOP}/dist-overlay/dist-smproxy)
...
LIB="smproxy"
VERSION="1.0.8"
TREE_DIR="${HERE}/build/smproxy-${VERSION}"
...
: "${DESTDIR:=${SUBSTRATE_TOP}/dist-overlay/dist-smproxy}"

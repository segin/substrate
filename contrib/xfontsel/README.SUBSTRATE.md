# xfontsel on Substrate

xfontsel 1.1.2, cross-built for `i386-unknown-substrate`.

Upstream tarball: `https://www.x.org/archive/individual/app/xfontsel-1.1.2.tar.gz`
...
./build.sh      # cross-configure, make, stage into dist-overlay/dist-xfontsel
```

`build.sh` stages into `${SUBSTRATE_TOP}/dist-overlay/dist-xfontsel/usr`, which

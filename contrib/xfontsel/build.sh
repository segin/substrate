#!/bin/sh
#
# contrib/xfontsel/build.sh — cross-build xfontsel for substrate.
#
# Point-and-click font selector.
#
# Env:
#   STAGE1_PREFIX   substrate toolchain prefix (default /opt/substrate)
#   DESTDIR         staging dir (default ${SUBSTRATE_TOP}/dist-overlay/dist-xfontsel)
...
LIB="xfontsel"
VERSION="1.1.2"
TREE_DIR="${HERE}/build/xfontsel-${VERSION}"
...
: "${DESTDIR:=${SUBSTRATE_TOP}/dist-overlay/dist-xfontsel}"

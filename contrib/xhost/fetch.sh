#!/bin/sh
#
# contrib/xhost/fetch.sh — fetch the xhost tarball, verify, extract,
# apply the substrate patch series (if any).

set -eu

VERSION="1.0.10"
TARBALL="xhost-${VERSION}.tar.gz"
...
TREE_DIR="${BUILD_DIR}/xhost-${VERSION}"
...
echo "==> xhost ${VERSION} ready at ${TREE_DIR}"

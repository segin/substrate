#!/bin/sh
#
# contrib/xhost/build.sh — cross-build xhost for substrate.
#
# Manage the host-based access control list.
#
# Env:
#   STAGE1_PREFIX   substrate toolchain prefix (default /opt/substrate)
#   DESTDIR         staging dir (default ${SUBSTRATE_TOP}/dist-overlay/dist-xhost)
...
LIB="xhost"
VERSION="1.0.10"
TREE_DIR="${HERE}/build/xhost-${VERSION}"
...
: "${DESTDIR:=${SUBSTRATE_TOP}/dist-overlay/dist-xhost}"

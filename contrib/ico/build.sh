#!/bin/sh
#
# contrib/ico/build.sh — cross-build ico for substrate.
#
# Animated polyhedron demo.
#
# Env:
#   STAGE1_PREFIX   substrate toolchain prefix (default /opt/substrate)
#   DESTDIR         staging dir (default ${SUBSTRATE_TOP}/dist-overlay/dist-ico)
...
LIB="ico"
VERSION="1.0.7"
TREE_DIR="${HERE}/build/ico-${VERSION}"
...
: "${DESTDIR:=${SUBSTRATE_TOP}/dist-overlay/dist-ico}"

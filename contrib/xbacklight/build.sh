#!/bin/sh
#
# contrib/xbacklight/build.sh — cross-build xbacklight for substrate.
#
# Adjust backlight brightness through RandR.
#
# Env:
#   STAGE1_PREFIX   substrate toolchain prefix (default /opt/substrate)
#   DESTDIR         staging dir (default ${SUBSTRATE_TOP}/dist-overlay/dist-xbacklight)
...
LIB="xbacklight"
VERSION="1.2.4"
TREE_DIR="${HERE}/build/xbacklight-${VERSION}"
...
: "${DESTDIR:=${SUBSTRATE_TOP}/dist-overlay/dist-xbacklight}"

# xbacklight on Substrate

xbacklight 1.2.4, cross-built for `i386-unknown-substrate`.

Upstream tarball: `https://www.x.org/archive/individual/app/xbacklight-1.2.4.tar.gz`
...
./build.sh      # cross-configure, make, stage into dist-overlay/dist-xbacklight
```

`build.sh` stages into `${SUBSTRATE_TOP}/dist-overlay/dist-xbacklight/usr`, which

#!/bin/sh
#
# contrib/xkbevd/build.sh — cross-build xkbevd for substrate.
#
# XKB event daemon.
#
# Env:
#   STAGE1_PREFIX   substrate toolchain prefix (default /opt/substrate)
#   DESTDIR         staging dir (default ${SUBSTRATE_TOP}/dist-overlay/dist-xkbevd)
...
LIB="xkbevd"
VERSION="1.1.6"
TREE_DIR="${HERE}/build/xkbevd-${VERSION}"
...
: "${DESTDIR:=${SUBSTRATE_TOP}/dist-overlay/dist-xkbevd}"

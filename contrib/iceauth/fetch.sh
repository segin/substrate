#!/bin/sh
#
# contrib/iceauth/fetch.sh — fetch the iceauth tarball, verify, extract,
# apply the substrate patch series.

set -eu

VERSION="1.0.10"
TARBALL="iceauth-${VERSION}.tar.xz"
...
TREE_DIR="${BUILD_DIR}/iceauth-${VERSION}"
...
echo "==> iceauth ${VERSION} ready at ${TREE_DIR}"

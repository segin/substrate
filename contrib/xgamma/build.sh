#!/bin/sh
#
# contrib/xgamma/build.sh — cross-build xgamma for substrate.
#
# Query and set monitor gamma through XF86VidMode.
#
# Env:
#   STAGE1_PREFIX   substrate toolchain prefix (default /opt/substrate)
#   DESTDIR         staging dir (default ${SUBSTRATE_TOP}/dist-overlay/dist-xgamma)
...
LIB="xgamma"
VERSION="1.0.8"
TREE_DIR="${HERE}/build/xgamma-${VERSION}"
...
: "${DESTDIR:=${SUBSTRATE_TOP}/dist-overlay/dist-xgamma}"

#!/bin/sh
#
# contrib/xclipboard/build.sh — cross-build xclipboard for substrate.
#
# Hold and browse CLIPBOARD selections.
#
# Env:
#   STAGE1_PREFIX   substrate toolchain prefix (default /opt/substrate)
#   DESTDIR         staging dir (default ${SUBSTRATE_TOP}/dist-overlay/dist-xclipboard)
...
LIB="xclipboard"
VERSION="1.1.6"
TREE_DIR="${HERE}/build/xclipboard-${VERSION}"
...
: "${DESTDIR:=${SUBSTRATE_TOP}/dist-overlay/dist-xclipboard}"

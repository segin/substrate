# libXdamage on Substrate

libXdamage 1.1.7, cross-built for `i386-unknown-substrate`.

Upstream tarball: `https://www.x.org/archive/individual/lib/libXdamage-1.1.7.tar.gz`
...
./build.sh      # cross-configure, make, stage into dist-overlay/dist-libXdamage
```

`build.sh` stages into `${SUBSTRATE_TOP}/dist-overlay/dist-libXdamage/usr`, which

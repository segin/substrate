#!/bin/sh
#
# contrib/libXdamage/build.sh — cross-build libXdamage for substrate.
#
# Client library for the Damage extension.
#
# Env:
#   STAGE1_PREFIX   substrate toolchain prefix (default /opt/substrate)
#   DESTDIR         staging dir (default ${SUBSTRATE_TOP}/dist-overlay/dist-libXdamage)
...
LIB="libXdamage"
VERSION="1.1.7"
TREE_DIR="${HERE}/build/libXdamage-${VERSION}"
...
: "${DESTDIR:=${SUBSTRATE_TOP}/dist-overlay/dist-libXdamage}"

#!/bin/sh
#
# contrib/xlsfonts/build.sh — cross-build xlsfonts for substrate.
#
# List the fonts a server knows about.
#
# Env:
#   STAGE1_PREFIX   substrate toolchain prefix (default /opt/substrate)
#   DESTDIR         staging dir (default ${SUBSTRATE_TOP}/dist-overlay/dist-xlsfonts)
...
LIB="xlsfonts"
VERSION="1.0.9"
TREE_DIR="${HERE}/build/xlsfonts-${VERSION}"
...
: "${DESTDIR:=${SUBSTRATE_TOP}/dist-overlay/dist-xlsfonts}"

# xlsfonts on Substrate

xlsfonts 1.0.9, cross-built for `i386-unknown-substrate`.

Upstream tarball: `https://www.x.org/archive/individual/app/xlsfonts-1.0.9.tar.gz`
...
./build.sh      # cross-configure, make, stage into dist-overlay/dist-xlsfonts
```

`build.sh` stages into `${SUBSTRATE_TOP}/dist-overlay/dist-xlsfonts/usr`, which

#!/bin/sh
#
# contrib/libXinerama/build.sh — cross-build libXinerama for substrate.
# The Xinerama client extension library (XineramaQueryScreens, ...).
# Mirrors contrib/libXext/build.sh.  Dependency of CDE.
#
# Env:
#   STAGE1_PREFIX   substrate toolchain prefix (default /opt/substrate)
#   DESTDIR         staging dir (default ${SUBSTRATE_TOP}/dist-overlay/dist-libXinerama)

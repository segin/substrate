#!/bin/sh
#
# contrib/xedit/fetch.sh — fetch the xedit tarball, verify, extract,
# apply the substrate patch series.

set -eu

VERSION="1.2.4"
TARBALL="xedit-${VERSION}.tar.xz"
...
TREE_DIR="${BUILD_DIR}/xedit-${VERSION}"
...
echo "==> xedit ${VERSION} ready at ${TREE_DIR}"

#!/bin/sh
#
# contrib/libICE/build.sh — cross-build libICE for substrate.
# the Inter-Client Exchange protocol library.
...
#   DESTDIR         staging dir (default ${SUBSTRATE_TOP}/dist-overlay/dist-libICE)

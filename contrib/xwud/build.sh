#!/bin/sh
#
# contrib/xwud/build.sh — cross-build xwud for substrate.
#
# Display an xwd dump.
#
# Env:
#   STAGE1_PREFIX   substrate toolchain prefix (default /opt/substrate)
#   DESTDIR         staging dir (default ${SUBSTRATE_TOP}/dist-overlay/dist-xwud)
...
LIB="xwud"
VERSION="1.0.8"
TREE_DIR="${HERE}/build/xwud-${VERSION}"
...
: "${DESTDIR:=${SUBSTRATE_TOP}/dist-overlay/dist-xwud}"

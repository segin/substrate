#!/bin/sh
#
# contrib/xconsole/build.sh — cross-build xconsole for substrate.
#
# Display console messages in a window.
#
# Env:
#   STAGE1_PREFIX   substrate toolchain prefix (default /opt/substrate)
#   DESTDIR         staging dir (default ${SUBSTRATE_TOP}/dist-overlay/dist-xconsole)
...
LIB="xconsole"
VERSION="1.1.1"
TREE_DIR="${HERE}/build/xconsole-${VERSION}"
...
: "${DESTDIR:=${SUBSTRATE_TOP}/dist-overlay/dist-xconsole}"

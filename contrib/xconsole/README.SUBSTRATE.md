# xconsole on Substrate

xconsole 1.1.1, cross-built for `i386-unknown-substrate`.

Upstream tarball: `https://www.x.org/archive/individual/app/xconsole-1.1.1.tar.gz`
...
./build.sh      # cross-configure, make, stage into dist-overlay/dist-xconsole
```

`build.sh` stages into `${SUBSTRATE_TOP}/dist-overlay/dist-xconsole/usr`, which

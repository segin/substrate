#!/bin/sh
#
# contrib/libXt/fetch.sh — fetch the libXt tarball, verify, extract,
# apply the substrate patch series.

set -eu

VERSION="1.3.1"
TARBALL="libXt-${VERSION}.tar.xz"
...
TREE_DIR="${BUILD_DIR}/libXt-${VERSION}"
...
echo "==> libXt ${VERSION} ready at ${TREE_DIR}"

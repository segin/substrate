#!/bin/sh
#
# contrib/xcompmgr/build.sh — cross-build xcompmgr for substrate.
#
# Sample compositing manager (Composite + Damage + Render).
#
# Env:
#   STAGE1_PREFIX   substrate toolchain prefix (default /opt/substrate)
#   DESTDIR         staging dir (default ${SUBSTRATE_TOP}/dist-overlay/dist-xcompmgr)
...
LIB="xcompmgr"
VERSION="1.1.10"
TREE_DIR="${HERE}/build/xcompmgr-${VERSION}"
...
: "${DESTDIR:=${SUBSTRATE_TOP}/dist-overlay/dist-xcompmgr}"

# xcompmgr on Substrate

xcompmgr 1.1.10, cross-built for `i386-unknown-substrate`.

Upstream tarball: `https://www.x.org/archive/individual/app/xcompmgr-1.1.10.tar.gz`
...
./build.sh      # cross-configure, make, stage into dist-overlay/dist-xcompmgr
```

`build.sh` stages into `${SUBSTRATE_TOP}/dist-overlay/dist-xcompmgr/usr`, which

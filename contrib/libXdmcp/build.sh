#!/bin/sh
# contrib/libXdmcp/build.sh — cross-build libXdmcp for substrate.
# Produces /usr/lib/libXdmcp.{a,so.1} + headers + pkgconfig.
#
# libXdmcp is a shared-memory fence primitive used by X clients
...
VERSION="1.1.5"
TREE_DIR="${HERE}/build/libXdmcp-${VERSION}"
...
: "${DESTDIR:=${SUBSTRATE_TOP}/dist-overlay/dist-libXdmcp}"
...
echo "==> Done.  libXdmcp staged under ${DESTDIR}"

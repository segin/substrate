#!/bin/sh
#
# contrib/libXmu/build.sh — cross-build libXmu for substrate.
# the X miscellaneous-utilities library.
...
#   DESTDIR         staging dir (default ${SUBSTRATE_TOP}/dist-overlay/dist-libXmu)

# libXrandr on Substrate

libXrandr 1.5.5, cross-built for `i386-unknown-substrate`.

Upstream tarball: `https://www.x.org/archive/individual/lib/libXrandr-1.5.5.tar.gz`
...
./build.sh      # cross-configure, make, stage into dist-overlay/dist-libXrandr
```

`build.sh` stages into `${SUBSTRATE_TOP}/dist-overlay/dist-libXrandr/usr`, which

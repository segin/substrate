#!/bin/sh
#
# contrib/libXrandr/build.sh — cross-build libXrandr for substrate.
#
# Client library for the RandR extension.
#
# Env:
#   STAGE1_PREFIX   substrate toolchain prefix (default /opt/substrate)
#   DESTDIR         staging dir (default ${SUBSTRATE_TOP}/dist-overlay/dist-libXrandr)
...
LIB="libXrandr"
VERSION="1.5.5"
TREE_DIR="${HERE}/build/libXrandr-${VERSION}"
...
: "${DESTDIR:=${SUBSTRATE_TOP}/dist-overlay/dist-libXrandr}"
...
PKGP=""; CPP=""; LDF=""
for d in xorgproto xcb-proto libXau xtrans libxcb libX11 libXext libXrender; do

# editres on Substrate

editres 1.1.1, cross-built for `i386-unknown-substrate`.

Upstream tarball: `https://www.x.org/archive/individual/app/editres-1.1.1.tar.gz`
...
./build.sh      # cross-configure, make, stage into dist-overlay/dist-editres
```

`build.sh` stages into `${SUBSTRATE_TOP}/dist-overlay/dist-editres/usr`, which

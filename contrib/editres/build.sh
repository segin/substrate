#!/bin/sh
#
# contrib/editres/build.sh — cross-build editres for substrate.
#
# Dynamic resource editor for Xt applications.
#
# Env:
#   STAGE1_PREFIX   substrate toolchain prefix (default /opt/substrate)
#   DESTDIR         staging dir (default ${SUBSTRATE_TOP}/dist-overlay/dist-editres)
...
LIB="editres"
VERSION="1.1.1"
TREE_DIR="${HERE}/build/editres-${VERSION}"
...
: "${DESTDIR:=${SUBSTRATE_TOP}/dist-overlay/dist-editres}"

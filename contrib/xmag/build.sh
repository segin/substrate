#!/bin/sh
#
# contrib/xmag/build.sh — cross-build xmag for substrate.
#
# Magnify part of the screen.
#
# Env:
#   STAGE1_PREFIX   substrate toolchain prefix (default /opt/substrate)
#   DESTDIR         staging dir (default ${SUBSTRATE_TOP}/dist-overlay/dist-xmag)
...
LIB="xmag"
VERSION="1.0.8"
TREE_DIR="${HERE}/build/xmag-${VERSION}"
...
: "${DESTDIR:=${SUBSTRATE_TOP}/dist-overlay/dist-xmag}"

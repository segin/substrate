#!/bin/sh
#
# contrib/xcursorgen/build.sh — cross-build xcursorgen for substrate.
#
# Build an Xcursor file from PNG images.
#
# Env:
#   STAGE1_PREFIX   substrate toolchain prefix (default /opt/substrate)
#   DESTDIR         staging dir (default ${SUBSTRATE_TOP}/dist-overlay/dist-xcursorgen)
...
LIB="xcursorgen"
VERSION="1.0.9"
TREE_DIR="${HERE}/build/xcursorgen-${VERSION}"
...
: "${DESTDIR:=${SUBSTRATE_TOP}/dist-overlay/dist-xcursorgen}"

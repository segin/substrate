#!/bin/sh
#
# contrib/bitmap/build.sh — cross-build bitmap for substrate.
#
# Bitmap editor, plus the bmtoa/atobm converters.
#
# Env:
#   STAGE1_PREFIX   substrate toolchain prefix (default /opt/substrate)
#   DESTDIR         staging dir (default ${SUBSTRATE_TOP}/dist-overlay/dist-bitmap)
...
LIB="bitmap"
VERSION="1.1.2"
TREE_DIR="${HERE}/build/bitmap-${VERSION}"
...
: "${DESTDIR:=${SUBSTRATE_TOP}/dist-overlay/dist-bitmap}"

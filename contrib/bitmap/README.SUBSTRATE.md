...
bitmap 1.1.2, cross-built for `i386-unknown-substrate`.

Upstream tarball: `https://www.x.org/archive/individual/app/bitmap-1.1.2.tar.gz`
...
./build.sh      # cross-configure, make, stage into dist-overlay/dist-bitmap
```

`build.sh` stages into `${SUBSTRATE_TOP}/dist-overlay/dist-bitmap/usr`, which

#!/bin/sh
#
# contrib/xpr/build.sh — cross-build xpr for substrate.
#
# Convert an xwd dump to PostScript, PCL or HP-GL.
#
# Env:
#   STAGE1_PREFIX   substrate toolchain prefix (default /opt/substrate)
#   DESTDIR         staging dir (default ${SUBSTRATE_TOP}/dist-overlay/dist-xpr)
...
LIB="xpr"
VERSION="1.2.1"
TREE_DIR="${HERE}/build/xpr-${VERSION}"
...
: "${DESTDIR:=${SUBSTRATE_TOP}/dist-overlay/dist-xpr}"

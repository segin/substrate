#!/bin/sh
#
# contrib/libjpeg/build.sh — cross-build IJG libjpeg for substrate.
# Produces libjpeg.so + static + headers + the cjpeg/djpeg tools.
# Dependency of CDE.
#
# Env:
#   STAGE1_PREFIX   substrate toolchain prefix (default /opt/substrate)
#   DESTDIR         staging dir (default ${SUBSTRATE_TOP}/dist-overlay/dist-libjpeg)
...
VERSION="9f"
TREE_DIR="${HERE}/build/jpeg-${VERSION}"
...
: "${DESTDIR:=${SUBSTRATE_TOP}/dist-overlay/dist-libjpeg}"
...
echo "==> Done.  libjpeg staged under ${DESTDIR}"

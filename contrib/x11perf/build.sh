#!/bin/sh
#
# contrib/x11perf/build.sh — cross-build x11perf for substrate.
#
# X server performance benchmark, with x11perfcomp to compare runs.
#
# Env:
#   STAGE1_PREFIX   substrate toolchain prefix (default /opt/substrate)
#   DESTDIR         staging dir (default ${SUBSTRATE_TOP}/dist-overlay/dist-x11perf)
...
LIB="x11perf"
VERSION="1.6.1"
TREE_DIR="${HERE}/build/x11perf-${VERSION}"
...
: "${DESTDIR:=${SUBSTRATE_TOP}/dist-overlay/dist-x11perf}"

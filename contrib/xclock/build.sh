#!/bin/sh
#
# contrib/xclock/build.sh — cross-build xclock for substrate.
#
# The classic analogue / digital clock.
#
# Env:
#   STAGE1_PREFIX   substrate toolchain prefix (default /opt/substrate)
#   DESTDIR         staging dir (default ${SUBSTRATE_TOP}/dist-overlay/dist-xclock)
...
LIB="xclock"
VERSION="1.2.1"
TREE_DIR="${HERE}/build/xclock-${VERSION}"
...
: "${DESTDIR:=${SUBSTRATE_TOP}/dist-overlay/dist-xclock}"

#!/bin/sh
#
# contrib/xmessage/build.sh — cross-build xmessage for substrate.
#
# Display a message or ask a question in a window.
#
# Env:
#   STAGE1_PREFIX   substrate toolchain prefix (default /opt/substrate)
#   DESTDIR         staging dir (default ${SUBSTRATE_TOP}/dist-overlay/dist-xmessage)
...
LIB="xmessage"
VERSION="1.0.7"
TREE_DIR="${HERE}/build/xmessage-${VERSION}"
...
: "${DESTDIR:=${SUBSTRATE_TOP}/dist-overlay/dist-xmessage}"

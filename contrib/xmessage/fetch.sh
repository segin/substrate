#!/bin/sh
#
# contrib/xmessage/fetch.sh — fetch the xmessage tarball, verify, extract,
# apply the substrate patch series (if any).

set -eu

VERSION="1.0.7"
TARBALL="xmessage-${VERSION}.tar.gz"
...
TREE_DIR="${BUILD_DIR}/xmessage-${VERSION}"
...
echo "==> xmessage ${VERSION} ready at ${TREE_DIR}"

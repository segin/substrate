#!/bin/sh
#
# contrib/bdftopcf/build.sh — cross-build bdftopcf for substrate.
#
# Convert BDF bitmap fonts to PCF, the format the X server loads.
#
# Env:
#   STAGE1_PREFIX   substrate toolchain prefix (default /opt/substrate)
#   DESTDIR         staging dir (default ${SUBSTRATE_TOP}/dist-overlay/dist-bdftopcf)
...
LIB="bdftopcf"
VERSION="1.1"
TREE_DIR="${HERE}/build/bdftopcf-${VERSION}"
...
: "${DESTDIR:=${SUBSTRATE_TOP}/dist-overlay/dist-bdftopcf}"

# bdftopcf on Substrate

bdftopcf 1.1, cross-built for `i386-unknown-substrate`.

Upstream tarball: `https://www.x.org/archive/individual/app/bdftopcf-1.1.tar.gz`
...
./build.sh      # cross-configure, make, stage into dist-overlay/dist-bdftopcf
```

`build.sh` stages into `${SUBSTRATE_TOP}/dist-overlay/dist-bdftopcf/usr`, which

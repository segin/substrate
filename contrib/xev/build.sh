#!/bin/sh
#
# contrib/xev/build.sh — cross-build xev for substrate.
#
# Print X events as they arrive.
#
# Env:
#   STAGE1_PREFIX   substrate toolchain prefix (default /opt/substrate)
#   DESTDIR         staging dir (default ${SUBSTRATE_TOP}/dist-overlay/dist-xev)
...
LIB="xev"
VERSION="1.2.7"
TREE_DIR="${HERE}/build/xev-${VERSION}"
...
: "${DESTDIR:=${SUBSTRATE_TOP}/dist-overlay/dist-xev}"

#!/bin/sh
#
# contrib/appres/build.sh — cross-build appres for substrate.
#
# List the X resource database entries an application would see.
#
# Env:
#   STAGE1_PREFIX   substrate toolchain prefix (default /opt/substrate)
#   DESTDIR         staging dir (default ${SUBSTRATE_TOP}/dist-overlay/dist-appres)
...
LIB="appres"
VERSION="1.0.7"
TREE_DIR="${HERE}/build/appres-${VERSION}"
...
: "${DESTDIR:=${SUBSTRATE_TOP}/dist-overlay/dist-appres}"

...
static uint32_t fuse_dev_read(fs_node_t *node, uint32_t offset, uint32_t size, uint8_t *buffer) {
...
static uint32_t fuse_dev_write(fs_node_t *node, uint32_t offset, uint32_t size, uint8_t *buffer) {
    (void)node; (void)offset;
...
static uint32_t fuse_vfs_read(fs_node_t *node, uint32_t offset, uint32_t size, uint8_t *buffer) {

...
/*
 * struct ksym and the ksym_table[]/ksym_count declarations live in
 * <kern/ksyms.h>.  The table is generated by the build system (parsing
 * kernel.map) and linked into the final binary.
 *

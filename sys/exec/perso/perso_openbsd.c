...
static void *openbsd_syscalls[MAX_SYSCALLS] = {
    ...
    /* OpenBSD unmount(2) takes (path, flags); use sys_umount2. */
    [OPENBSD_SYS_unmount]        = &sys_umount2,
    ...
    /* AF_UNIX sockets — route through substrate's sys/net/af_unix.c. */
    [OPENBSD_SYS_recvmsg]        = &sys_recvmsg,
    [OPENBSD_SYS_sendmsg]        = &sys_sendmsg,
    [OPENBSD_SYS_recvfrom]       = &sys_recvfrom,
    [OPENBSD_SYS_accept]         = &sys_accept,
    [OPENBSD_SYS_getpeername]    = &sys_getpeername,
    [OPENBSD_SYS_getsockname]    = &sys_getsockname,
    ...
    [OPENBSD_SYS_socket]         = &sys_socket,
    [OPENBSD_SYS_connect]        = &sys_connect,
    [OPENBSD_SYS_compat_accept]  = &sys_accept,    /* compat: identical surface */
    [OPENBSD_SYS_getpriority]    = NULL,            /* getpriority */
    [OPENBSD_SYS_compat_send]    = &sys_send,
...
static const char *openbsd_names[MAX_SYSCALLS] = {
    ...
    [OPENBSD_SYS_sendto]         = "sendto",
    [OPENBSD_SYS_shutdown]       = "shutdown",
    [OPENBSD_SYS_socketpair]     = "socketpair",
};
...
static struct syscall_fmt openbsd_fmts[MAX_SYSCALLS] = {
    ...
    [OPENBSD_SYS_unmount]        = { 2, { ARG_STR, ARG_HEX } },

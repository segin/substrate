...
static void *native_syscalls[MAX_SYSCALLS] = {
    ...
    [SYS_SYNC] = &sys_sync,
    [SYS_KILL] = &sys_kill,
    [SYS_SIGQUEUE] = (void *)&sys_sigqueue,
    [SYS_MKDIR] = &sys_mkdir,
    ...
    [SYS_KSEM_OPEN]      = (void *)&sys_ksem_open,
    [SYS_KSEM_CLOSE]     = (void *)&sys_ksem_close,
    [SYS_KSEM_UNLINK]    = (void *)&sys_ksem_unlink,
    [SYS_KSEM_WAIT]      = (void *)&sys_ksem_wait,
    [SYS_KSEM_TRYWAIT]   = (void *)&sys_ksem_trywait,
    [SYS_KSEM_TIMEDWAIT] = (void *)&sys_ksem_timedwait,
    [SYS_KSEM_POST]      = (void *)&sys_ksem_post,
    [SYS_KSEM_GETVALUE]  = (void *)&sys_ksem_getvalue,
    [SYS_MQ_OPEN]         = (void *)&sys_mq_open,
    [SYS_MQ_CLOSE]        = (void *)&sys_mq_close,
    [SYS_MQ_UNLINK]       = (void *)&sys_mq_unlink,
    [SYS_MQ_TIMEDSEND]    = (void *)&sys_mq_timedsend,
    [SYS_MQ_TIMEDRECEIVE] = (void *)&sys_mq_timedreceive,
    [SYS_MQ_NOTIFY]       = (void *)&sys_mq_notify,
    [SYS_MQ_GETSETATTR]   = (void *)&sys_mq_getsetattr,
    [SYS_UNAME] = &sys_uname,
    ...
    [SYS_SCHED_SETPARAM]         = (void *)&sys_sched_setparam,
    [SYS_SCHED_GETPARAM]         = (void *)&sys_sched_getparam,
    [SYS_SCHED_SETSCHEDULER]     = (void *)&sys_sched_setscheduler,
    [SYS_SCHED_GETSCHEDULER]     = (void *)&sys_sched_getscheduler,
    [SYS_SCHED_GET_PRIORITY_MAX] = (void *)&sys_sched_get_priority_max,
    [SYS_SCHED_GET_PRIORITY_MIN] = (void *)&sys_sched_get_priority_min,
    [SYS_SCHED_RR_GET_INTERVAL]  = (void *)&sys_sched_rr_get_interval,
    ...
    [SYS_GETRLIMIT] = (void*)&sys_native_getrlimit,
    [SYS_SETRLIMIT] = (void*)&sys_native_setrlimit,
    [SYS_MLOCKALL]  = (void*)&sys_native_mlockall,
...
static struct syscall_fmt native_fmts[MAX_SYSCALLS] = {
    ...
    [SYS_SIGQUEUE] = { 3, { ARG_INT, ARG_INT, ARG_HEX } },
    ...
    [SYS_MPROTECT] = { 3, { ARG_PTR, ARG_INT, ARG_HEX } },
    ...
    [SYS_KSEM_OPEN]      = { 4, { ARG_STR, ARG_HEX, ARG_HEX, ARG_INT } },
    [SYS_KSEM_CLOSE]     = { 1, { ARG_INT } },
    [SYS_KSEM_UNLINK]    = { 1, { ARG_STR } },
    [SYS_KSEM_WAIT]      = { 1, { ARG_INT } },
    [SYS_KSEM_TRYWAIT]   = { 1, { ARG_INT } },
    [SYS_KSEM_TIMEDWAIT] = { 2, { ARG_INT, ARG_PTR } },
    [SYS_KSEM_POST]      = { 1, { ARG_INT } },
    [SYS_KSEM_GETVALUE]  = { 2, { ARG_INT, ARG_PTR } },
    [SYS_MQ_OPEN]         = { 4, { ARG_STR, ARG_HEX, ARG_INT, ARG_PTR } },
    [SYS_MQ_CLOSE]        = { 1, { ARG_INT } },
    [SYS_MQ_UNLINK]       = { 1, { ARG_STR } },
    [SYS_MQ_TIMEDSEND]    = { 5, { ARG_INT, ARG_PTR, ARG_INT, ARG_INT, ARG_PTR } },
    [SYS_MQ_TIMEDRECEIVE] = { 5, { ARG_INT, ARG_PTR, ARG_INT, ARG_PTR, ARG_PTR } },
    [SYS_MQ_NOTIFY]       = { 2, { ARG_INT, ARG_PTR } },
    [SYS_MQ_GETSETATTR]   = { 3, { ARG_INT, ARG_PTR, ARG_PTR } },
    [SYS_UNAME] = { 1, { ARG_PTR } },
    ...
    [SYS_SCHED_YIELD]  = { 0, { 0 } },
    [SYS_SCHED_SETPARAM]         = { 2, { ARG_INT, ARG_PTR } },
    [SYS_SCHED_GETPARAM]         = { 2, { ARG_INT, ARG_PTR } },
    [SYS_SCHED_SETSCHEDULER]     = { 3, { ARG_INT, ARG_INT, ARG_PTR } },
    [SYS_SCHED_GETSCHEDULER]     = { 1, { ARG_INT } },
    [SYS_SCHED_GET_PRIORITY_MAX] = { 1, { ARG_INT } },
    [SYS_SCHED_GET_PRIORITY_MIN] = { 1, { ARG_INT } },
    [SYS_SCHED_RR_GET_INTERVAL]  = { 2, { ARG_INT, ARG_PTR } },
    ...
    [SYS_GETRLIMIT] = { 2, { ARG_INT, ARG_PTR } },
    [SYS_SETRLIMIT] = { 2, { ARG_INT, ARG_PTR } },
    [SYS_MLOCKALL]  = { 1, { ARG_INT } },
    [SYS_SETEUID]   = { 1, { ARG_INT } },

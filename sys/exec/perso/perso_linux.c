...
static void *linux_syscalls[MAX_SYSCALLS] = {
    ...
    [LINUX_SYS_execve]         = (void *)&sys_execve,
    [LINUX_SYS_chdir]          = (void *)&kern_chdir,
    [LINUX_SYS_time]           = (void *)&kern_time,
    [LINUX_SYS_mknod]          = NULL,
    [LINUX_SYS_chmod]          = (void *)&sys_chmod,
    [LINUX_SYS_lchown]         = (void *)&sys_lchown,
    ...
    [LINUX_SYS_chroot]         = (void *)&sys_chroot,
    ...
    [LINUX_SYS_readdir]        = (void *)&linux_old_readdir,
    ...
    [LINUX_SYS_mprotect]       = (void *)&sys_mprotect,
    ...
    [LINUX_SYS_fstatat64]      = (void *)linux_sys_fstatat64,
    [LINUX_SYS_readlinkat]     = (void *)&sys_readlinkat,
    [LINUX_SYS_fchownat]       = (void *)&sys_fchownat,
    ...
    [LINUX_SYS_chown]          = (void *)&sys_chown,
    ...
    [LINUX_SYS_chown32]        = (void *)&sys_chown,

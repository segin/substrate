...
static void run_case(const v81_case_t *tc) {
    as_a64_v81_insn_t in;
    uint8_t out[8];
    size_t out_len = 0;
    char err[192];
    ...
    if (as_a64_encode_v81(&in, out, sizeof(out), &out_len, err, sizeof(err)) != 0) {
...
static const v81_case_t k_cases[] = {

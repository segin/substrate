...
"$CC_BIN" -std=c23 native_c23_empty_param.c -o /tmp/cc_native_c23_empty_param
/tmp/cc_native_c23_empty_param

"$CC_BIN" -std=c23 native_c23_asm_extension.c -o /tmp/cc_native_c23_asm_extension
/tmp/cc_native_c23_asm_extension
...
! "$CC_BIN" -std=c23 -c native_bad_c23_empty_param_call.c -o /tmp/cc_native_bad_c23_empty_param_call.o

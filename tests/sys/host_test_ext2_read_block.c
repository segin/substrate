...
int main() {
     ...
     * on-disk metadata bounds check).  Make the filesystem large enough
     * that every block number exercised below (incl. the 0x80000000
     * 64-bit-offset cases) passes the guard. */

...
- the VirtIO family no longer performs its own private PCI rescan during init; it registers a PCI driver against the framework-owned PCI device list and binds existing devices through the generic probe/attach path.

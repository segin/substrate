...
| **COFF Loader** | Beta | [Doc](docs/specs/exec_coff.md) | [tests/unit/exec/test_coff.c](tests/unit/exec/test_coff.c) | [tests/unit/exec/prop_exec_coff.c](tests/unit/exec/prop_exec_coff.c) | [tests/fuzz/fuzz_exec_coff.c](tests/fuzz/fuzz_exec_coff.c) |
| **FreeBSD kinfo** | Beta | [Doc](docs/specs/perso_freebsd_kinfo.md) | [tests/unit/perso/test_freebsd_kinfo.c](tests/unit/perso/test_freebsd_kinfo.c) | [tests/unit/perso/prop_perso_freebsd_kinfo.c](tests/unit/perso/prop_perso_freebsd_kinfo.c) | [tests/fuzz/fuzz_perso_freebsd_kinfo.c](tests/fuzz/fuzz_perso_freebsd_kinfo.c) |
